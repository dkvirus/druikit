...
const CalendarOutlined = ({
  ...
  return (
    ...
    >
      <rect opacity="0.424438" width="22" height="22" fill="url(#pattern0)" />
      <defs>
        <pattern
          id="pattern0"
