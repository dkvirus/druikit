...
var _excluded = ["style", "className", "value", "onChange", "onClick", "disabled", "options", "size", "label", "labelStyle", "labelClassName", "placeholder", "dropdownTitle", "dropdownStyle", "dropdownClassName", "dropdownLabelStyle", "dropdownLabelClassName", "dropdownHeight", "showSearch"];
...
var getFilterOptions = function getFilterOptions(options, searchValue) {
  if (!searchValue) {
  ...
  return _toConsumableArray(filterOptions);
};
var Select = function Select(_ref) {
  ...
  useEffect(function () {
    var newOptions = getFilterOptions(options, searchValue);
    setDropdownOptions(_toConsumableArray(newOptions));
  }, [searchValue]);
  var searchEl = null;
  if (showSearch) {
    ...
    if (typeof item.value === 'string') {
      return /*#__PURE__*/React.createElement(SelectOption, {
        ...
        onClick: function onClick() {
          return _onClick === null || _onClick === void 0 ? void 0 : _onClick(item.value);
        }
      }, item.label);
    }
    return /*#__PURE__*/React.createElement(SelectOption, {
  ...
  return /*#__PURE__*/React.createElement(BaseSelect, _extends({
    ...
    style: style,
    className: className,
    onOpenChanged: function onOpenChanged(open) {
