...
export declare const WEEKS_ABBR: string[];
export declare const WEEKS_ZH: string[];
export declare const MONTHS: string[];
export declare const MONTHS_ABBR: string[];
export declare const MONTHS_ZH: string[];
/**
 * 获取某一个月份总共有多少天
 * month: 1 - 12
 */
