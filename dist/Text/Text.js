...
var _excluded = ["style", "className", "fontSize", "fontSize32", "fontSize16", "fontSize14", "fontSize12", "color", "color666", "colorBlue", "colorRed", "capitalize", "uppercase", "lowercase", "pointer", "children"];
...
export var Text = function Text(_ref) {
  ...
  var sty = _objectSpread(_objectSpread(_objectSpread({}, getFontSize({
    fontSize: fontSize,
